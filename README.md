...
The ICMP echo request packet generated by the Generator on the left is shown in the 33st line of the Monitor. The ICMP echo reply packet is shown as the 34nd line, and a more detailed view of it is shown in the image below.
