...
>[!TIP] 
> While in Generator mode, output of `bpf_printk` of [this code](https://github.com/ddddddO/packemon/blob/main/egress_control/egress_packet.bpf.c) can be checked by executing the following command. 
